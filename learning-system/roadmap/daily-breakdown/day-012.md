# Day 012: Sysmon Event ID 3 (Network Connection)

**Phase:** Phase 1: Foundation
**Focus:** Sysmon Event ID 3 (Network Connection)

---

## Learning Objectives

- Understand the fundamentals of Sysmon Event ID 3 (Network Connection)
- Practice hands-on Sysmon Event ID 3 (Network Connection) techniques in HawkinsOps environment
...
- Sysmon Event ID 3 (Network Connection) is critical for SOC analysts to detect threats early
...
**LAB-02 to LAB-04: Windows Event Correlation and Linux Syslog**
...
Day 12 complete. Review your progress and plan for tomorrow.

**Progress:** Day 12 of 365 (3.3% complete)
