...
- **ID:** IR-002
- **Severity:** High
- **Primary MITRE ATT&CK:** T1059.001

## 1) Detection
**Typical signals**
- Encoded/obfuscated PowerShell, suspicious download/execute patterns
...
- Admin scripts, software deployment tools, legitimate automation
