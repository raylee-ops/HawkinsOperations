# Day 008: Wazuh SIEM queries

**Phase:** Phase 1: Foundation
**Focus:** Wazuh SIEM queries

---

## Learning Objectives

- Understand the fundamentals of Wazuh SIEM queries
- Practice hands-on Wazuh SIEM queries techniques in HawkinsOps environment
...
- Wazuh SIEM queries is critical for SOC analysts to detect threats early
...
Day 8 complete. Review your progress and plan for tomorrow.

**Progress:** Day 8 of 365 (2.2% complete)
