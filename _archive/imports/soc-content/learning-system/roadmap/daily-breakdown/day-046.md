# Day 046: PowerShell log queries

**Phase:** Phase 1: Foundation
**Focus:** PowerShell log queries

---

## Learning Objectives

- Understand the fundamentals of PowerShell log queries
- Practice hands-on PowerShell log queries techniques in HawkinsOps environment
...
- PowerShell log queries is critical for SOC analysts to detect threats early
...
Day 46 complete. Review your progress and plan for tomorrow.

**Progress:** Day 46 of 365 (12.6% complete)
