# Day 011: Sysmon Event ID 1 (Process Creation)
...
- Understand the fundamentals of Sysmon Event ID 1 (Process Creation)
- Practice hands-on Sysmon Event ID 1 (Process Creation) techniques in HawkinsOps environment
...
- Sysmon Event ID 1 (Process Creation) is critical for SOC analysts to detect threats early
...
Day 11 complete. Review your progress and plan for tomorrow.

**Progress:** Day 11 of 365 (3.0% complete)
