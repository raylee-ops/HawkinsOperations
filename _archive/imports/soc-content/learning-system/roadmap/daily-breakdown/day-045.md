# Day 045: Windows Event Logs

**Phase:** Phase 1: Foundation
**Focus:** Windows Event Logs

---

## Learning Objectives

- Understand the fundamentals of Windows Event Logs
- Practice hands-on Windows Event Logs techniques in HawkinsOps environment
...
- Windows Event Logs is critical for SOC analysts to detect threats early
...
Day 45 complete. Review your progress and plan for tomorrow.

**Progress:** Day 45 of 365 (12.3% complete)
